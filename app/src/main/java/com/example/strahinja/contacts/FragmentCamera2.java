...
//    }
    ...
    public static FragmentCamera2 newInstance() {
        return new FragmentCamera2();
    }
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        view.findViewById(R.id.camera_info).setOnClickListener(this);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mFile = new File(getActivity().getExternalFilesDir(null), EditActivity.currentContact.getFirstName()+"_"+EditActivity.currentContact.getLastName()+".jpg");
    }
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            ...
            ErrorDialog.newInstance("Error! This device doesn\'t support Camera2 API")
                    .show(getChildFragmentManager(), FRAGMENT_DIALOG);
        }
    }

    /**
     * Opens the camera specified by {@link FragmentCamera2#mCameraId}.
     */
            ...
            case R.id.camera_info: {
                ...
                if (null != activity) {
                    new AlertDialog.Builder(activity)
                            .setMessage("Welcome to Camera2API")
